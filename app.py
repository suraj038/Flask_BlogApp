...
class Posts(db.Model):
    ...
    tagline = db.Column(db.String(5000), nullable=False)
    date = db.Column(db.String(12), nullable=True)
...
def dashboard():
    ...
    if request.method == 'POST':
        ...
        if(username == params['admin_user'] and useremail == params['admin_email'] and userpass == params['admin_password']):
